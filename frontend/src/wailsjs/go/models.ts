...
export namespace backend {
	...
	export class OneBrowserKernelStatus {
	    installed: boolean;
	    version: string;
	    coreId: string;
	
	    static createFrom(source: any = {}) {
	        return new OneBrowserKernelStatus(source);
	    }
	...
	export class OneBrowserStartRequest {
	    ...
	    static createFrom(source: any = {}) {
	        return new OneBrowserStartRequest(source);
	    }
	...
	export class OneBrowserStartResult {
	    profileId: string;
	    running: boolean;
	
	    static createFrom(source: any = {}) {
	        return new OneBrowserStartResult(source);
	    }
